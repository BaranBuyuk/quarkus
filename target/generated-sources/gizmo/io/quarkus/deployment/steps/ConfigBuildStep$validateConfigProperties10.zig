// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties10
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties10#deploy_0
    RETURN
    ** label2
